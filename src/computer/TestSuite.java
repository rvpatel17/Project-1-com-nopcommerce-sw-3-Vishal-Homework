...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //2.22 Fill the all mandatory field
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Vishal");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Patel");
        sendTextToElement(By.id("BillingNewAddress_Email"), "contacttovishal@gmial.com");
        sendTextToElement(By.id("BillingNewAddress_Company"), "Vish1234");
        selectByValueFromDropDown(By.id("BillingNewAddress_CountryId"), "9");
